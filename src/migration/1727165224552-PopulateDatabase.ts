...
export class RecreateAndPopulateTables1234567890123
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Drop existing tables if they exist
    await queryRunner.query(`DROP TABLE IF EXISTS orders CASCADE`);
    await queryRunner.query(`DROP TABLE IF EXISTS marketdata CASCADE`);
    ...
    for (const [ticker, name, type] of instrumentsData) {
      await queryRunner.query(
        `
    ...
    for (const [
      ...
      await queryRunner.query(
        `
            ...
            `,
        [instrumentId, date, open, high, low, close, previousClose],
      );
    }
    ...
    for (const [
      ...
      await queryRunner.query(
        `
            ...
            `,
        [instrumentId, userId, size, price, side, status, type, datetime],
      );
    }
  }
